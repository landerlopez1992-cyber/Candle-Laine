...
export const screens = {
  ...
  OrderHistoryEmpty,
  MyPromocodesEmpty,
  ShippingAPaymentInfo,
  SignUpAccountCreated,
  EmailHasBeenVerified,
  CheckoutPaymentMethod,
  CheckoutInstallmentsPick,
